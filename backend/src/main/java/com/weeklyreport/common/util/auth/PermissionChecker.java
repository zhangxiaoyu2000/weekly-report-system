...
public class PermissionChecker {
     ...
     * 项目创建者、管理员、超级管理员可以查看
     */
    public boolean canViewProject(Project project, CustomUserPrincipal userPrincipal) {
        // 项目创建者可以查看
        if (project.getCreatedBy().equals(userPrincipal.getId())) {
            return true;
        }
     ...
     * 项目创建者且项目已审批通过才能创建周报
     */
    public boolean canCreateWeeklyReport(Project project, CustomUserPrincipal userPrincipal) {
        // 必须是项目创建者
        if (!project.getCreatedBy().equals(userPrincipal.getId())) {
            return false;
        }
        ...
        // 项目必须已审批通过
        return project.getApprovalStatus() == Project.ApprovalStatus.SUPER_ADMIN_APPROVED ||
     ...
     * 项目创建者、老板、HR可以查看
     */
    public boolean canViewProjectReports(Project project, CustomUserPrincipal userPrincipal) {
