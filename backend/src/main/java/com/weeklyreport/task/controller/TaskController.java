package com.weeklyreport.task.controller;

import com.weeklyreport.common.dto.ApiResponse;
import com.weeklyreport.task.dto.TaskCreateRequest;
import com.weeklyreport.task.dto.TaskResponse;
...
import com.weeklyreport.task.repository.TaskReportRepository;
import com.weeklyreport.task.repository.DevTaskReportRepository;
...
public class TaskController {
    ...
    public ResponseEntity<ApiResponse<Page<TaskResponse>>> getAllTasks(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ApiResponse.error("获取任务列表失败，请稍后重试"));
        }
    }
    ...
    public ResponseEntity<ApiResponse<TaskResponse>> createTask(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ApiResponse.error("创建任务失败，请稍后重试"));
        }
    }
     ...
     */
    @GetMapping("/{id}")
    @PreAuthorize("@taskPermissionEvaluator.canViewTask(#id, authentication)")
    public ResponseEntity<ApiResponse<TaskResponse>> getTask(@PathVariable Long id) {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ApiResponse.error("获取任务信息失败，请稍后重试"));
        }
    }
     ...
     */
    @PutMapping("/{id}")
    @PreAuthorize("@taskPermissionEvaluator.canManageTask(#id, authentication)")
    public ResponseEntity<ApiResponse<TaskResponse>> updateTask(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ApiResponse.error("更新任务失败，请稍后重试"));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deleteTask(@PathVariable Long id) {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ApiResponse.error("删除任务失败，请稍后重试"));
        }
    }
    ...
    public ResponseEntity<ApiResponse<List<TaskResponse>>> getMyTasks() {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ApiResponse.error("获取我的任务列表失败，请稍后重试"));
        }
    }
    ...
    public ResponseEntity<ApiResponse<List<TaskResponse>>> getTasksByType(@PathVariable String taskType) {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ApiResponse.error("按类型获取任务失败，请稍后重试"));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Object>> getTaskStatistics() {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ApiResponse.error("获取任务统计数据失败，请稍后重试"));
        }
    }
    ...
    public ResponseEntity<ApiResponse<List<TaskResponse>>> getTasksByReport(@PathVariable Long reportId) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ApiResponse.error("获取报告任务失败，请稍后重试"));
        }
    }
}
