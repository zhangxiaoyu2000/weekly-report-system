...
public class WeeklyReportResponse {
    ...
    // 单一状态字段（5状态系统）
    private WeeklyReport.ReportStatus status;       // 周报状态
    ...
    public WeeklyReportResponse(WeeklyReport report) {
        ...
        // 周报创建后即进入AI分析，因此submittedAt等于createdAt
        this.submittedAt = report.getCreatedAt();
    ...
    // Helper methods - 基于5状态系统
    public boolean isDraft() {
        return status == WeeklyReport.ReportStatus.DRAFT;
    }

    public boolean isSubmitted() {
        return status == WeeklyReport.ReportStatus.AI_PROCESSING ||
    ...
    public boolean isRejected() {
        return status == WeeklyReport.ReportStatus.REJECTED;
    }
