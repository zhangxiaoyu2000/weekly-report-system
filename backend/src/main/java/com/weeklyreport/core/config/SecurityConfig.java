...
import com.weeklyreport.core.security.*;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers("/health/**").permitAll()  // Allow all health check endpoints
                .requestMatchers("/actuator/health/**").permitAll()
                .requestMatchers("/public/**").permitAll()
                .requestMatchers("/debug/**").permitAll()  // Debug endpoints for development
                .requestMatchers("/test/**").permitAll()  // Test endpoints for development
                .requestMatchers("/test-comments/**").permitAll()  // Comment debug endpoints
                .requestMatchers("/simple-test").permitAll()  // Simple test endpoint
                ...
                // Weekly Report Comments - must be BEFORE weekly-reports/** to avoid being overridden
                .requestMatchers(HttpMethod.GET, "/weekly-reports/*/comments").hasAnyAuthority("ROLE_ADMIN", "ROLE_MANAGER", "ROLE_SUPER_ADMIN")
                .requestMatchers(HttpMethod.POST, "/weekly-reports/*/comments").hasAnyAuthority("ROLE_ADMIN", "ROLE_MANAGER", "ROLE_SUPER_ADMIN")

                // Weekly reports (general)
                ...
                // Simple weekly reports endpoints (backward compatibility)
